...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
        ...
        for i, (paired_data, bs_data) in enumerate(zip(paired_dataset, bs_dataset)):
            ...
            if epoch > 20 and total_iters % opt.display_freq == 0:   # display images on visdom and save images to a HTML file
            ...
            if total_iters % opt.print_freq == 0:    # print training losses and save logging information to the disk
                ...
                if opt.display_id > 0:
                    if not opt.no_gan: # Need to debug, with no_gan flag, this visualization didn't work!
